...
java -Dtls.enable=true -Dtls.trustStore.path=/certs/truststore.jks -Dtls.trustStore.passwordPath=/secrets/keystore-password \
    ...
    -Dzk.address=wal-1-zk-client:2281 -Dzk.path=/pravega/wal-1-pv/bookkeeper/ledgers \
    -jar bkperf-1.0-SNAPSHOT-all.jar

# locally
java -Dzk.address=127.0.0.1:2181 -Dzk.path=/ledgers \
    -jar ./build/libs/bkperf-1.0-SNAPSHOT-all.jar